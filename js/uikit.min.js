/*! UIkit 2.19.0 | http://www.getuikit.com | (c) 2014 YOOtheme | MIT License */ ! function(t) {
    ...
    var n = {},
        o = window.UIkit;
    if (n.version = "2.19.0", n.noConflict = function() {
            return o && (window.UIkit = o, i.UIkit = o, i.fn.uk = o.fn), n
        }, n.prefix = function(t) {
            return t
        }, n.$ = i, n.$doc = n.$(document), n.$win = n.$(window), n.$html = n.$("html"), n.fn = function(t, e) {
            var o = arguments,
                s = t.match(/^([a-z\-]+)(?:\.([a-z]+))?/i),
                a = s[1],
                r = s[2];
...
function(t) {
    ...
    t.component("stackMargin", {
        ...
        return t.$win.on("resize", t.Utils.debounce(e, 15)),
            function(n) {
...
function(t) {
    ...
    var i = t.$win,
        ...
        n = [],
        o = function() {
            for (var i = 0; i < n.length; i++) t.support.requestAnimationFrame.apply(window, [n[i].check])
        };
                ...
                s = function() {
                    ...
                    n.each(function() {
                        var n = t.$(this),
                            ...
                            c = t.Utils.isInView(n, e.options),
                            l = n.data("ukScrollspyCls") || o[a].trim();
    ...
    t.component("dropdown", {
        ...
        init: function() {
            ...
            this.dropdown = this.find(".uk-dropdown"), this.centered = this.dropdown.hasClass("uk-dropdown-center"), this.justified = this.options.justify ? t.$(this.options.justify) : !1, this.boundary = t.$(this.options.boundary), this.flipped = this.dropdown.hasClass("uk-dropdown-flip"), this.boundary.length || (this.boundary = t.$win), this.element.attr("aria-haspopup", "true"), this.element.attr("aria-expanded", this.element.hasClass("uk-open")), "click" == this.options.mode || t.support.touch ? this.on("click.uikit.dropdown", function(i) {
                var n = t.$(i.target);
                n.parents(".uk-dropdown").length || ((n.is("a[href='#']") || n.parent().is("a[href='#']") || e.dropdown.length && !e.dropdown.is(":visible")) && i.preventDefault(), n.blur()), e.element.hasClass("uk-open") ? (n.is("a:not(.js-uk-prevent)") || n.is(".uk-dropdown-close") || !e.dropdown.find(i.target).length) && e.hide() : e.show()
            }) : this.on("mouseenter", function() {
                e.remainIdle && clearTimeout(e.remainIdle), i && clearTimeout(i), i = setTimeout(e.show.bind(e), e.options.delay)
                ...
                var n = t.$(i.target);
                e.remainIdle && clearTimeout(e.remainIdle), (n.is("a[href='#']") || n.parent().is("a[href='#']")) && i.preventDefault(), e.show()
            })
        },
        show: function() {
                ...
                if (this.centered && (e.css("margin-" + t.langdirection, -1 * (parseFloat(o) / 2 - e.parent().width() / 2)), n = e.offset(), (o + n.left > s || n.left < 0) && (e.css("margin-" + t.langdirection, ""), n = e.offset())), this.justified && this.justified.length) {
                    ...
                    if (e.css("min-width", r), "right" == t.langdirection) {
                        var c = s - (this.justified.offset().left + r),
                            l = s - (e.offset().left + e.outerWidth());
            ...
            _initElement: function(i) {
                i.data("OffcanvasInit") || (i.on("click.uk.offcanvas swipeRight.uk.offcanvas swipeLeft.uk.offcanvas", function(i) {
                    ...
                    "#" != e && (t.$doc.one("hide.uk.offcanvas", function() {
                        var i = t.$(e);
                        i.length || (i = t.$('[name="' + e.replace("#", "") + '"]')), t.Utils.scrollToElement && i.length ? t.Utils.scrollToElement(i) : window.location.href = e
                    }), n.hide())
        ...
        show: function(n, o) {
            if (!this.animating) {
                ...
                var a = this,
                    ...
                    r = t.$(n),
                    c = e[this.options.animation] || function(t, n) {
        ...
        check: function() {
            ...
            if (i.length) {
                ...
                if (this.responsivetab.lst.empty(), i.each(function() {
                    ...
                    for (var a = 0; a < i.length; a++) e = t.$(i.eq(a)), n = e.find("a"), "none" == e.css("float") || e.attr("uk-dropdown") || (e.addClass("uk-hidden"), e.hasClass("uk-disabled") || this.responsivetab.lst.append('<li><a href="' + n.attr("href") + '" data-index="' + a + '">' + n.html() + "</a></li>"));
